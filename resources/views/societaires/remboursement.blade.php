...
.modal-box .field input{width:100%;padding:12px 14px;border-radius:10px;border:1.5px solid var(--line);font-size:14px;font-family:'Manrope',sans-serif;transition:all .25s cubic-bezier(.4,0,.2,1);}
...
function openModal(id, date, maxMontant) {
    ...
    document.getElementById('modalMontant').placeholder = 'Max : ' + maxMontant.replace('.', ',') + ' F';
