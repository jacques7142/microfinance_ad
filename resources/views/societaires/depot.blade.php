...
<div class="content-wrapper">
    ...
    <div class="page-card">
        ...
        <p class="sub">Effectuez un dépôt sur l'un de vos comptes d'épargne. L'opération est immédiate.</p>
        ...
        <form method="POST" action="{{ route('societaire.depot.store') }}">
            ...
            <p class="sub" style="margin-bottom:18px;">Une invite de validation sera envoyée sur votre téléphone. L'opération sera confirmée automatiquement après votre accord.</p>
            <button class="btn-submit" type="submit"><span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>Payer et effectuer le dépôt</span></button>
        </form>
    </div>
</div>
